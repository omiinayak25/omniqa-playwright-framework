...
- Name: ui/saucedemo/cart.data.spec.ts >> SauceDemo · Cart add/remove per product @ui @regression @cart >> "Sauce Labs Bike Light" can be added and removed
- Location: tests/ui/saucedemo/cart.data.spec.ts:32:9
