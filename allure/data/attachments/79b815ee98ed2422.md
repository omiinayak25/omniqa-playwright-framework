...
- Name: visual/saucedemo/cart.visual.spec.ts >> SauceDemo · Cart & Checkout · Visual @visual @regression >> the cart page matches the baseline
- Location: tests/visual/saucedemo/cart.visual.spec.ts:25:7
