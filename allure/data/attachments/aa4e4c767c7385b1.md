...
- Name: ui/saucedemo/checkout.security.spec.ts >> SauceDemo · Checkout input security @ui @regression @security @checkout >> very long names are accepted without breaking the form
- Location: tests/ui/saucedemo/checkout.security.spec.ts:82:7
