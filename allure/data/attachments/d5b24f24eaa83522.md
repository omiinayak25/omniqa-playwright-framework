...
- Name: ui/orangehrm/authorization.spec.ts >> OrangeHRM · Authorization — Admin privileges @ui @regression @authorization >> Admin can open the PIM module
- Location: tests/ui/orangehrm/authorization.spec.ts:58:7
...
Call log:
  - waiting for locator('.oxd-main-menu-item').filter({ hasText: 'PIM' }).first()
