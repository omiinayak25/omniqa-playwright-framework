...
- Name: ui/saucedemo/cart.persistence.spec.ts >> SauceDemo · Cart persistence & navigation @ui @regression @cart >> checkout from the cart opens checkout step one
- Location: tests/ui/saucedemo/cart.persistence.spec.ts:89:7
