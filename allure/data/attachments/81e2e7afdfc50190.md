...
- Name: visual/saucedemo/cart.visual.spec.ts >> SauceDemo · Cart & Checkout · Visual @visual @regression >> the checkout information page matches the baseline
- Location: tests/visual/saucedemo/cart.visual.spec.ts:33:7
