...
- Name: ui/orangehrm/add-employee.spec.ts >> OrangeHRM · Add Employee form @ui @regression @forms >> mismatched login passwords are rejected
- Location: tests/ui/orangehrm/add-employee.spec.ts:147:7
...
Call log:
  - waiting for locator('.oxd-input-group').filter({ has: locator('label').filter({ hasText: 'Username' }) }).locator('input')
          ...
          - generic [ref=e161]:
            - generic [ref=e162]:
              - generic [ref=e165]:
                ...
                - generic [ref=e168]:
                  - textbox "名字" [ref=e171]: Brigitte
                  - textbox "中间名" [ref=e174]
                  - textbox "姓" [ref=e177]: Gusikowski
              - generic [ref=e180]:
