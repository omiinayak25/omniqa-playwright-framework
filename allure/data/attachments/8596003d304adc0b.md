...
- Name: ui/saucedemo/authorization.spec.ts >> SauceDemo · Authorization — protected routes @ui @regression @authorization @negative >> checkout (step one) deep-link without a session is not served
- Location: tests/ui/saucedemo/authorization.spec.ts:33:7
